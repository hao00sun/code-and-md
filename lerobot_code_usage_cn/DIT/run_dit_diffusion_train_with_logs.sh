...
# MultiTaskDiT diffusion training launcher.
# Usage:
#   ./DIT/run_dit_diffusion_train_with_logs.sh DIT/multi_task_dit_diffusion_train.yaml

CONFIG_PATH="${1:-DIT/multi_task_dit_diffusion_train.yaml}"
...
RUN_NAME="multi_task_dit_diffusion_arx_${TIME_TAG}"
...
echo "[INFO] MODE        = train diffusion from scratch"
